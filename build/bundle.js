...
exports.default = removePagination;
function removePagination(length) {
  var paginationList = document.querySelector('.pagination__list');
  var paginationItems = paginationList.children;

  for (var i = 0, len = paginationItems.length; i < len; i += 1) {
...
exports.default = requestYouTube;

var _lodash = __webpack_require__(6);

var _lodash2 = _interopRequireDefault(_lodash);

var _tplAwesome = __webpack_require__(9);

var _tplAwesome2 = _interopRequireDefault(_tplAwesome);

var _controlPaginationNext = __webpack_require__(10);

var _controlPaginationNext2 = _interopRequireDefault(_controlPaginationNext);

var _controlPaginationPrev = __webpack_require__(11);

var _controlPaginationPrev2 = _interopRequireDefault(_controlPaginationPrev);

var _getPageX = __webpack_require__(12);

var _getPageX2 = _interopRequireDefault(_getPageX);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var currentListnerUp = void 0;
var currentListnerDown = void 0;
var currentListnerLeave = void 0;
var currentListnerMove = void 0;

function requestYouTube(token, maxRes) {
  // prepare the request
  ...
  if (searchValue !== '') {
    ...
    request.execute(function (response) {
      ...
      currentListnerDown = function listnerDown(e) {
        isDown = true;
        var pageX = (0, _getPageX2.default)(e);
      ...
      currentListnerMove = function listnerMove(e) {
        ...
        e.preventDefault();
        var pageX = (0, _getPageX2.default)(e);
        var x = pageX - content.offsetLeft;

        walk = x - startX;

        var walkPerc = walk * 100 / bodyWidth;
        var shift = -50 + walkPerc;
      ...
      // render cycle start
      _lodash2.default.each(results.items, function (item) {
        var requestTwo = gapi.client.request({
          method: 'GET',
        ...
        requestTwo.execute(function (response) {
          var data = response.items[0];
          var id = data.id,
              _data$snippet = data.snippet,
              title = _data$snippet.title,
              description = _data$snippet.description,
              channelTitle = _data$snippet.channelTitle,
              url = _data$snippet.thumbnails.medium.url,
              viewCount = data.statistics.viewCount;
          var publishedAt = data.snippet.publishedAt;

          publishedAt = publishedAt.slice(0, 10);

          fetch('./template/item.html').then(function (response) {
            return response.text().then(function (dataTpl) {
              if (response.ok) {
                return dataTpl;
              }return false;
            });
          }).then(function (dataTpl) {
            var someLi = document.createElement('li');
            someLi.innerHTML = (0, _tplAwesome2.default)(dataTpl, [{
              id: id, url: url, title: title, description: description, channelTitle: channelTitle, publishedAt: publishedAt, viewCount: viewCount
            }]);
...
var _addClickForm = __webpack_require__(4);

var _addClickForm2 = _interopRequireDefault(_addClickForm);

var _changeTheme = __webpack_require__(13);

var _changeTheme2 = _interopRequireDefault(_changeTheme);

var _requestYouTube = __webpack_require__(1);

var _requestYouTube2 = _interopRequireDefault(_requestYouTube);

var _removePagination = __webpack_require__(0);

var _removePagination2 = _interopRequireDefault(_removePagination);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

// change theme start
var themeBtn = document.getElementById('themeBtn');
themeBtn.addEventListener('click', _changeTheme2.default);
// change theme end
...
var laptop = window.matchMedia('(max-width: 1200px) and (min-width: 900px)');
var tablet = window.matchMedia('(max-width: 900px) and (min-width: 580px)');
var mobile = window.matchMedia('(max-width: 580px)');

var paginationList = document.querySelector('.pagination__list');
var paginationItems = paginationList.children;
var addClickForm = (0, _addClickForm2.default)();
...
var resizeListner = function resizeble() {
  if (mobile.matches) {
    isDesktop = false;
    isLaptop = false;
    isTablet = false;
    ...
    if (!isMobile) {
      (0, _requestYouTube2.default)('', 1);
      (0, _removePagination2.default)(paginationItems.length);
    }
...
exports.default = getAddClickFormFn;

var _createLayout = __webpack_require__(5);
...
var template = document.querySelector('#main').innerHTML;
var templParallax = document.querySelector('#parallax').innerHTML;
var main = '.s-main';
var parallax = '.s-parallax';

(0, _createLayout2.default)(template, main);
(0, _createLayout2.default)(templParallax, parallax);

var paginationList = document.querySelector('.pagination__list');

function getAddClickFormFn() {
  var onSubmitFn = void 0;

  return function (elem, defaultToken, maxRes) {
    var paginationItems = paginationList.children;
    ...
    onSubmitFn = function onSubmitFn(e) {
      e.preventDefault();
      (0, _removePagination2.default)(paginationItems.length);
      (0, _requestYouTube2.default)(defaultToken, maxRes);
    };
...
function createLayout(template, selector) {
  var body = document.getElementsByTagName('body')[0];
  var fragment = document.createElement('div');
  fragment.innerHTML = template;
  var parent = fragment.querySelector(selector);
  fragment = null;
...
exports.default = controlPaginationNext;
function controlPaginationNext() {
  var paginationList = document.querySelector('.pagination__list');
  var paginationItems = paginationList.children;

  for (var i = 0, len = paginationItems.length; i < len; i += 1) {
    if (paginationItems[i].classList.contains('pagination__item_is-active')) {
      var condition1 = paginationItems[i].getAttribute('data-page') >= 5;
      var condition2 = Number(paginationItems[i].getAttribute('data-page')) === 4 || len === 5;
      var condition3 = len === 3 && Number(paginationItems[i].getAttribute('data-page')) === 1;
      var condition4 = len === 4 && Number(paginationItems[i].getAttribute('data-page')) === 2;
      var condition5 = len === 4 && Number(paginationItems[i].getAttribute('data-page')) === 1;

      if (condition1) {
        var currentAttr = paginationItems[i].getAttribute('data-page');
      ...
      var page = paginationItems[i].getAttribute('data-page');
...
exports.default = controlPaginationPrev;
function controlPaginationPrev() {
  var paginationList = document.querySelector('.pagination__list');
  var paginationItems = paginationList.children;
...
function changeTheme() {
  var body = document.getElementsByTagName('body')[0];
  body.style.backgroundColor = 'hsl(' + (0, _random2.default)(0, 360) + ',' + (0, _random2.default)(0, 100) + '%,' + (0, _random2.default)(0, 55) + '%)';
}
